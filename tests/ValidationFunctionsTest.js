...
const   providerValidatePossibility = require('./BaseTestCase.js').providerValidatePossibility,
    ...
    function setUp(){
        validator = new app.ValidationFunctions();
    }
     ...
     * @return {Array}
     */
    function providerValidateKnownTestNumbers(){
        return [
     ...
     * @return {Array}
     */
    function providerValidateLength(){
        return [
     ...
     * @return {Array}
     */
    function providerValidateProvider(){
        return [
     ...
     */
    describe('validateKnownTestNumber', function(){
        setUp();
        providerValidateKnownTestNumbers().forEach(function(row){
            ...
            it('should equal expected result for test'+testName, function(){
                assert.equal(validator.validateKnownTestNumbers(testNumber), expectedResult);
            });
        });
    });
    ...
    describe('validateLength', function(){
        setUp();
        providerValidateLength().forEach(function(row){
            const testName = row[0];
            const testNumber = row[1];
            const expectedResult = row[2];
            it('should equal expected result for test'+testName, function(){
                assert.equal(validator.validateLength(testNumber), expectedResult);
            })
        });
    });
     ...
     */
    describe('validateLUHN', function(){
        setUp();
        providerValidateLUHN().forEach(function(row){
            const testName = row[0];
            const testNumber = row[1];
            const expectedResult = row[2];
            it('should equal expected result for test'+testName, function(){
                assert.equal(validator.validateLUHN(testNumber), expectedResult);
            })
        });
    });
     ...
     */
    describe('validatePossibility', function(){
        setUp();
        providerValidatePossibility().forEach(function(row){
            ...
            const expectedResult = row[2];
            it('should equal expected result for test'+testName, function(){
                assert.equal(validator.validatePossibility(testNumber), expectedResult);
            })
        });
    });
    ...
    describe('validateProvider', function(){
        setUp();
        providerValidateProvider().forEach(function(row){
            const testName = row[0];
            const testNumber = row[1];
            const expectedResult = row[2];
            it('should equal expected result for test'+testName, function(){
                assert.equal(validator.validateProvider(testNumber), expectedResult);
            })
        });
    });